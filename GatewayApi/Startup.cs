...
namespace GatewayApi
{
    public class Startup
    {
        ...
        {
            // We want to interact with orchestrator hosted service from within controllers and from event listener hosted service.
            services.AddSingleton<OrchestratorService>();
            services.AddHostedService(provider => provider.GetRequiredService<OrchestratorService>());
